#!/opt/netbox-zabbix-sync/.venv/bin/python3
...
logging.basicConfig(filename="webhook-app.log", level=logging.DEBUG,format='%(lineno)d - %(asctime)s [%(levelname)s] - %(message)s')
...
SLA_SCRIPT_PATH = os.environ.get("SLA_SCRIPT_PATH")
